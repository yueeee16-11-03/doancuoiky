...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dona.Model.Games", b =>
                {
            ...
            modelBuilder.Entity("dona.Model.Lane", b =>
                {
            ...
            modelBuilder.Entity("dona.Model.PathChampions", b =>
                {
                    ...
                    b.ToTable("PathChampions");
                });

            modelBuilder.Entity("dona.Model.SkillChampions", b =>
                {
                    ...
                    b.ToTable("SkillChampions");
                });

            modelBuilder.Entity("dona.Model.SkinChampions", b =>
                {
            ...
            modelBuilder.Entity("dona.Model.tblChampions", b =>
                {
                    ...
                    b.Property<string>("Description_destail")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SkillsChampions")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SkinChampions")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("dona.Model.Lane", b =>
                {
                    b.HasOne("dona.Model.Games", "Games")
                        .WithMany()
